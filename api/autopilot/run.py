...
from stockoracle.autopilot import run_autopilot  # noqa: E402


app = FastAPI(title="StockOracle Autopilot Run API")
...
def execute(payload: AutopilotRequest, authorization: str | None = Header(default=None)) -> dict[str, Any]:
    try:
        _validate_autopilot_access(payload.autopilotToken, authorization)
        return run_autopilot(force=payload.force)
